<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<!-- Header row -->
		<xsl:text>URL&#9;Title&#9;First Name&#9;Middle Name&#9;Last Name&#9;Name Suffix&#9;Rights holder&#9;Document Type&#9;Degree Name&#9;Department&#9;Major&#9;Keywords&#9;Disciplines&#9;Advisor1&#9;Advisor2&#9;Advisor3&#9;Institution&#9;Publication Date&#9;Copyright Date&#9;Embargo Date&#9;Abstract&#9;&#xa;</xsl:text>
		...
		<xsl:for-each select="documents/document">
			...
			<!-- Empty column for major to be added -->
			<xsl:text>&#9;</xsl:text>
