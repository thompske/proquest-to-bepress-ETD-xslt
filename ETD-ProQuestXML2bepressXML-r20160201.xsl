...
<!-- 
	...
	YOU NEED TO FILL IN YOUR OWN FILE SERVER URL ON LINE 1485.
 -->
			...
			<xsl:for-each select="DISS_submission">
				<document>
						...
						<xsl:for-each
							select="DISS_description/DISS_categorization/DISS_category/DISS_cat_desc">
								<xsl:choose>
									...
									<xsl:when test=".='Area planning &amp; development'">
									...
									<xsl:when test=".='Educational sociology'">
									...
									<xsl:when test=".='Multimedia communications'">
										<discipline>Broadcast and Video Studies</discipline>
					...
					<fulltext-url>
							...
							<xsl:value-of
								select="concat('http://lamp.lib.iastate.edu/DR/r20160201/', $pdfpath)"/>
